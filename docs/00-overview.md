...
1. コードを変更する
2. GitHub や GitLab に push / Pull Request / Merge Request を行う
3. CIが実行される
4. 問題がなければCDが実行される
5. 環境に変更が反映される

![image](./assets/overview/cicd-flow.drawio.png)
...
どのツールを使う場合でも、コードの変更をきっかけに検証を実行し、必要に応じてデプロイまでつなげる、という基本的な考え方は共通しています。

このプラクティスでは、その中でも GitHub Actions と GitLab CI を扱います。
