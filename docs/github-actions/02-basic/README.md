...
`<リポジトリ>/.github/workflows` ディレクトリを作成し、次の条件を満たす workflow ファイルを 1 つ作成してください。
...
> 確認：
>
> - .github/workflows 配下に YAML ファイルが作成されている
> - workflow 名、on、jobs、steps を含む workflow の骨組みが作成されている
